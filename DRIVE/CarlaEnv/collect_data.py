...
class CarlaDataCollector:
    """
        To be able to drive in this environment, either start CARLA beforehand with:
    ...
    def __init__(self, host="127.0.0.1", port=2000, 
        ...
        try:
            ...
            self.client.load_world('/Game/Carla/Maps/Town07')  # LJW:
            ...
            settings.fixed_delta_seconds = 1 / self.fps # LJW: 
            ...
            self.dashcam_seg = Camera(self.world, out_width, out_height,
                                      ...
                                      camera_type="sensor.camera.semantic_segmentation", custom_palette=True)#, color_converter=carla.ColorConverter.CityScapesPalette)
...
if __name__ == "__main__":
    ...
    argparser.add_argument("--output_dir", default="/home/jk/Coppeliasim_carla/Carla-ppo/vae/my_data", type=str, help="Directory to save images to")
    ...
    # LJW:
    argparser.add_argument("-start_carla", action="store_true", help="Automatically start CALRA with the given environment settings", default=True)
